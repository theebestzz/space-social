...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "rounded-2x w-fulll mx-auto flex h-16 items-end gap-4 bg-gray-50 px-4 pb-3 dark:bg-neutral-900",
        className,
      )}
    >
      {items.map((item) => (
  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className="relative flex aspect-square w-full items-center justify-center rounded-full bg-black"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
